...
export function ProductCard({ item }: { item: ProductCardItem }) {
  return (
    <a
      ...
      className="group block rounded-2xl overflow-hidden bg-white border border-brand-border shadow-[0_1px_2px_rgba(47,47,45,0.04)] hover:shadow-[0_1px_3px_rgba(47,47,45,0.08)] transition"
    >
      ...
      <div className="p-3 md:p-4">
        ...
        {item.price ? (
          <div className="mt-2 text-[14px] md:text-[15px] font-bold text-brand-text">{item.price}</div>
        ) : null}
      </div>
    </a>
  )
