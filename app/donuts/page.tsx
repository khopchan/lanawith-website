    ...
    <div className="min-h-screen bg-white">
      <header className="bg-white/90 backdrop-blur-sm sticky top-0 z-50 border-b border-brand-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <a
            href="/"
            className="font-serif text-2xl text-brand-text hover:text-brand-text-muted transition-colors"
          >
            LANA WITH.
          </a>
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="/about" className="text-brand-text hover:text-brand-text-muted transition-colors japanese-text">
              私たちについて
            </a>
          </nav>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <h1 className="font-heading-jp text-3xl md:text-4xl text-brand-text mb-6">
                オートミール焼きドーナツ
              </h1>
              <p className="text-lg md:text-xl text-brand-text-muted leading-relaxed max-w-3xl mx-auto japanese-text">
      ...
      <section className="py-20 bg-brand-bg-alt">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-heading-jp text-2xl md:text-3xl text-brand-text text-center mb-12">
              ドーナツの特徴
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center space-y-4">
                ...
                <h3 className="font-heading-jp text-lg text-brand-text">家族で楽しめる</h3>
                <p className="text-brand-text-muted leading-relaxed japanese-text text-sm">
                  小さなお子様から大人まで、みんなで一緒に楽しめる優しい味わいです。
                </p>
              </div>
              <div className="text-center space-y-4">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto border border-brand-border">
                  <Leaf className="w-8 h-8 text-brand-text" />
                </div>
                <h3 className="font-heading-jp text-lg text-brand-text">オートミール使用</h3>
                <p className="text-brand-text-muted leading-relaxed japanese-text text-sm">
              ...
              <div className="text-center space-y-4">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto border border-brand-border">
                  <Award className="w-8 h-8 text-brand-text" />
                </div>
                <h3 className="font-heading-jp text-lg text-brand-text">4つの味</h3>
                <p className="text-brand-text-muted leading-relaxed japanese-text text-sm">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-heading-jp text-2xl md:text-3xl text-brand-text mb-4">
            新しいオートミールスイーツを体験してみませんか？
          </h2>
          <p className="text-lg text-brand-text-muted mb-8 max-w-2xl mx-auto japanese-text">
