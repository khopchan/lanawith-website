      ...
      <div className="mx-auto max-w-4xl px-5 py-12 md:py-16">
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-heading-jp text-brand-text">LANA WITH.のはじまり</h2>
          </div>
...
LANA WITH.は、日々の暮らしにそっと寄り添い、記憶に残るおいしさをお届けします。`}
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-heading-jp text-brand-text">選びやすさへの工夫</h2>
          </div>
...
商品を手に取る前から、おいしさを想像できるネーミングを心がけています。`}
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-heading-jp text-brand-text">LANAが生まれた理由</h2>
          </div>
          <div className="bg-white rounded-2xl p-6 md:p-8 border border-brand-border">
            <p className="text-base md:text-lg leading-relaxed text-brand-text whitespace-pre-line">
