...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-page-gray">
      {/* Header */}
      ...
      <div className="mx-auto max-w-4xl px-5 py-12 md:py-16">
        ...
        <section className="mb-16">
          ...
          <div className="bg-page-gray rounded-2xl p-6 md:p-8 shadow-sm border border-[#EADBC8]/30">
        ...
        <section className="mb-16">
          ...
          <div className="bg-page-gray rounded-2xl p-6 md:p-8">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-page-gray rounded-2xl p-6 shadow-sm border border-[#EADBC8]/30">
