...
export const donutSetProduct: DonutProduct = {
  ...
  weight: "65g×6個",
  shipping: "送料：クール便（冷凍便）でお届け。配送先の地域・サイズにより異なります（5,000円以上のご購入で国内送料無料）",
  ...
  shippingInfo:
    "ご注文（お支払い確定）後、順次発送いたします。毎週月曜日までのご注文で最短翌日発送となる場合がございます。クール宅急便（冷凍便）でお届けし、ドーナツは冷凍状態で届きます。送料は配送先の地域・サイズにより異なります（5,000円以上のご購入で国内送料無料）。",
  setContents: [
